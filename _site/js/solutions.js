   ...
   {  
      ...
      "childs":[  
         {  
            ...
            "image": "https://s3-us-west-1.amazonaws.com/drawdown-images/afforestation.png",
         ...
         {  
            ...
            "image": "https://s3-us-west-1.amazonaws.com/drawdown-images/bamboo.png",
         ...
         {  
            ...
            "image": "https://s3-us-west-1.amazonaws.com/drawdown-images/coastal-wetlands.png",
         ...
         {  
            ...
            "image": "https://dummyimage.com/100X50/000/fff",
         ...
         {  
            ...
            "image": "https://dummyimage.com/100X50/000/fff",
            "url" : "https://www.drawdown.org/solutions/land-use/indigenous-peoples’-land-management"
         },
         {  
            "name":"Peatlands",
   ...
   {  
      ...
      "childs":[  
         {  
            ...
            "image": "https://dummyimage.com/100X50/000/fff",
            "url" : "https://www.drawdown.org/solutions/"
         },
         {  
   ...
   {  
      ...
      "childs":[  
         ...
         {  
            ...
            "description":"Managed grazing imitates the activity of migratory herds to improve soil health, carbon sequestration, water retention, and forage productivity.",
            "image": "https://dummyimage.com/100X50/000/fff",
            "url" : "https://www.drawdown.org/solutions/"
         },
         {  
   ...
   {  
      ...
      "childs":[  
         ...
         {  
            ...
            "description":"High-speed rail is the fastest way to travel distances between 100 to 700 miles. Compared to driving or flying, it reduces emissions up to 90 percent.",
            "image": "https://dummyimage.com/100X50/000/fff",
            "url" : "https://www.drawdown.org/solutions/"
         },
         {  
...
$(window).load(function() {
    ...
    function drawCards(name, childs) {
        var name = document.getElementById(name);
        $(name).find('.solution-cards').empty();
        $.each(childs, function(i, val) {
            $(name).find('.solution-cards').append('<article class="solution-card">' +
                '<span>' +
                '<picture class="thumbnail"><img alt="img" src="'+ val.image + '"></picture>' +
                '<div class="solution-card-content">' +
                '<h2>' + val.name + '</h2>' +
                '<p style="padding-bottom: 15px;">' + val.description + '</p>' +
                '<p class="learn-more">' +
                '<a href="'+ val.url + '" target="_blank">Learn more' + '</a>' +
                '</p'+
                '</span>' +
                '</div>' +
                '</article>');
